...
- Proof of work is a mathematical problem that takes [[Time|time]] to solve. Solving it proves that you've spent some time trying combinations until it worked. Proof of work creates scarcity. The blockchain knows that the miners are spending their time and resources on proving the mathematical puzzles.
