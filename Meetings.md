...
- [Include a detailed agenda with time estimates for each item](https://abitmighty.com/posts/the-ultimate-meeting-culture).
...
- When asking for a meeting, send a message with:
  ...
  2. **Duration.** State restrictions (i.e. "at least 30 min", "at most 50 min").
