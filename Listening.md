...
- Avoid trying to respond immediately and allow the other person [[Time|time]] to finish speaking.
...
- Use [[Open Questions|open questions]] more. Open questions are any questions that cannot be answered with a simple _yes_ or _no_ reply.
