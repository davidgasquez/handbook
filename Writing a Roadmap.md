...
- **Iterate, iterate, iterate**: Review this draft with stakeholders to assess whether cross-cutting dependencies can be met, if you're prioritizing the right work, and which gaps or [[Open Questions|open questions]] you haven't thought of yet.
- **Finalize**: Get sign-off on this version of the roadmap for the upcoming [[Time|time]] window. Present it to cross-functional partners and start using it as a [[Communication|communication]] device to align effort, priorities, and cross-team information sharing.
