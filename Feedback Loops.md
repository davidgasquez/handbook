...
- There are two types of feedback loops: positive and negative.
  ...
  - Negative feedback dampens output, stabilizes the system around an equilibrium point.
...
- Feedback loops vary in their accuracy.
  - Accurate [[Feedback|feedback]] means that it **reliably** and **clearly** tells you when you do something right. If you get the quadratic formula wrong, you can check the right formula and know what was wrong.
  - An inaccurate feedback loop means that the results of the evaluation phase are “**noisy**” and contain significant variance, so the next cycle will need to take that into account. E.g: playing bowls without a coach.
...
- Artist making music while they experience life without fame. Once fame gets in they don't have the same life experience and can't produce the same type of music.
...
- The [[Science#Metascience]] learning loop: trial new social [[Processes|processes]] → evaluate effectiveness → scale successful approaches → amplify transformative changes. A positive feedback loop designed to systematically improve how science itself operates.
