...
1. Explore the data. [Inspect provenance, ordering, leakage, labeling quality, and real records](https://ludic.mataroa.blog/blog/breaking-my-universitys-machine-learning-competition/) before tuning the model. Verify any assumptions. Garbage in, garbage out. Remove ALL friction from looking at data.
...
- [Chart Dos and Don'ts](https://guides.lib.uci.edu/datavis/do)
