...
- One of the biggest misconceptions about data is that **it is correct** or it will be at some point. Data quality will always be an issue, defining [[Metrics|metrics]] for data quality helps you know where you stand, improve over [[Time|time]], and align with your team.
...
- A table might be good enough for one consumer but not for the other consumer.
...
- Data Quality has many dimensions:
  ...
  - **Usability**: Can the data be accessed and understood in a low-friction manner?
...
- You can use these [guiding principles to think about data quality](https://www.metaplane.dev/blog/data-quality-metrics-for-data-warehouses):
  ...
  - **Connect to data quality dimensions** and **describe how to measure them as metrics**: Of the causes of recent trouble, how do they relate to the previous data quality dimensions?
  - **Make [[Metrics|metrics]] digestible and actionable**: Lastly, how can we make those metrics useful?
