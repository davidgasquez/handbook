...
- Confidence Interval Game. Select a continuous variable (Iceland Population). Everyone precommits a 95% confidence interval answer. If you're out, you lose 20 points. Among those who are in, the smallest interval on a logarithmic scale earns points equal to the number of players who are in.
