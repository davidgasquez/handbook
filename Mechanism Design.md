...
- The Revelation Principle lets us [[Focus|focus]] on direct, truth-telling mechanisms: DSIC (dominant strategies) or BIC (Bayes-Nash).
...
- You can increase mechanism complexity if you trade it off for [[Identity|identity]] or collusion resistance. If you figure out a way to make the mechanism identity-resistant, it'll support more complex setups.
...
- Quadratic voting and funding as a way of coming to agreement on matters of [[Governance|governance]] and [[Public Goods Funding]].
...
- **Prediction and Decision Markets (Futarchy)**. ["Vote values, bet beliefs"](https://medium.com/ethereum-optimism/retroactive-public-goods-funding-33c9b7d00f0c) - conditional markets choose policies that maximize agreed-upon [[Metrics|metrics]].
...
- **Conviction Voting** - Preferences gain strength over [[Time|time]] rather than snapshot voting. Voters continuously express preferences and conviction builds, reducing governance attacks.
...
- **Privacy Pools** - Systems that maintain participant [[Privacy|privacy]] while excluding provably malicious actors. Allow honest participants to prove non-membership in bad actor sets without revealing their identity.
- **Reinforcement Learning for Meta-Evaluation** - Use RL to evolve evaluation mechanisms through trial and error. The system [[Learning|learns]] which evaluation approaches work best in different contexts by treating mechanism selection as a sequential decision problem.
