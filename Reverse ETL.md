...
- It provides a source of truth for all the tools: **the data warehouse**.
  ...
  - It removes some tools' limitations (e.g. Customer.io's ways of doing segmentation, Pendo's limitation on events cohort).
  - SQL Queries will return the same numbers as other BI tools like Mixpanel.
